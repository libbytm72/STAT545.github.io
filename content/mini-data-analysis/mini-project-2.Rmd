...
1. How does age of tree relate to genus and what are the most commonly planted genuses by year?
2. How are different ages of trees distributed throughout the city?
3. Where are the largest trees in the city?
4. What is the distribution of the genus Acer accross the city?
<!----------------------------------------------------------------------------->
...
Used count function to see the number of observations for each genus, this is helpful to know how many trees of each genus there are in the data set. 
vancouver_trees %>%
count(genus_name)
...
Created new catagorical variable of tree age as "sappling, young, mature, old" 
van_trees_age <- vancouver_trees %>% 
  mutate(age_class = case_when( date_planted < 2020-01-01 ~ "sappling",
                                date_planted < 2005-01-01 ~ "young",
                                date_planted < 1980-01-01 ~ "mature",
                                TRUE ~ "old"))
...
Created new catagorical variable for tree diameter as "small, medium, large, and huge"
van_trees_dbh <- vancouver_trees %>% 
  mutate(dbh_class = case_when( diameter < 30 ~ "small",
                                diameter < 60 ~ "medium",
                                diameter < 90 ~ "large",
                                TRUE ~ "huge"))
Graphing
